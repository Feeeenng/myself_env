...
# from D:\ProgramData\Anaconda3\lib\site-packages\win32comext\directsound\directsound.pyd
# by generator 1.145
...
IID_IDirectSound = None # (!) real value is ''

IID_IDirectSoundBuffer = None # (!) real value is ''

IID_IDirectSoundCapture = None # (!) real value is ''

IID_IDirectSoundCaptureBuffer = None # (!) real value is ''

IID_IDirectSoundNotify = None # (!) real value is ''
