...
# from D:\ProgramData\Anaconda3\lib\site-packages\win32comext\taskscheduler\taskscheduler.pyd
# by generator 1.145
...
CLSID_CTask = None # (!) real value is ''

CLSID_CTaskScheduler = None # (!) real value is ''

IID_IProvideTaskPage = None # (!) real value is ''

IID_IScheduledWorkItem = None # (!) real value is ''

IID_ITask = None # (!) real value is ''

IID_ITaskScheduler = None # (!) real value is ''

IID_ITaskTrigger = None # (!) real value is ''
