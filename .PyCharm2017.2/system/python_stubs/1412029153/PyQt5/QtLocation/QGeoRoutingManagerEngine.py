...
class QGeoRoutingManagerEngine(__PyQt5_QtCore.QObject):
    ...
    def setSupportedFeatureTypes(self, QGeoRouteRequest_FeatureTypes): # real signature unknown; restored from __doc__
        """ setSupportedFeatureTypes(self, QGeoRouteRequest.FeatureTypes) """
        pass

    def setSupportedFeatureWeights(self, QGeoRouteRequest_FeatureWeights): # real signature unknown; restored from __doc__
        """ setSupportedFeatureWeights(self, QGeoRouteRequest.FeatureWeights) """
        pass

    def setSupportedManeuverDetails(self, QGeoRouteRequest_ManeuverDetails): # real signature unknown; restored from __doc__
        """ setSupportedManeuverDetails(self, QGeoRouteRequest.ManeuverDetails) """
        pass

    def setSupportedRouteOptimizations(self, QGeoRouteRequest_RouteOptimizations): # real signature unknown; restored from __doc__
        """ setSupportedRouteOptimizations(self, QGeoRouteRequest.RouteOptimizations) """
        pass

    def setSupportedSegmentDetails(self, QGeoRouteRequest_SegmentDetails): # real signature unknown; restored from __doc__
        """ setSupportedSegmentDetails(self, QGeoRouteRequest.SegmentDetails) """
        pass

    def setSupportedTravelModes(self, QGeoRouteRequest_TravelModes): # real signature unknown; restored from __doc__
        """ setSupportedTravelModes(self, QGeoRouteRequest.TravelModes) """
        pass
