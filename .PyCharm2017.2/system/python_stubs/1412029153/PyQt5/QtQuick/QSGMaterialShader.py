...
class QSGMaterialShader(): # skipped bases: <class 'sip.wrapper'>
    """ QSGMaterialShader() """
    ...
    def setShaderSourceFile(self, QOpenGLShader_ShaderType, p_str): # real signature unknown; restored from __doc__
        """ setShaderSourceFile(self, QOpenGLShader.ShaderType, str) """
        pass

    def setShaderSourceFiles(self, QOpenGLShader_ShaderType, Iterable, p_str=None): # real signature unknown; restored from __doc__
