...
# from D:\ProgramData\Anaconda3\lib\site-packages\scipy\special\_ufuncs_cxx.cp36-win_amd64.pyd
# by generator 1.145
# no doc
...
__pyx_capi__ = {
    ...
    '_export_faddeeva_log_ndtr': None, # (!) real value is ''
    '_export_faddeeva_ndtr': None, # (!) real value is ''
    '_export_faddeeva_w': None, # (!) real value is ''
    '_export_wrightomega': None, # (!) real value is ''
    '_set_action': None, # (!) real value is ''
}
