...
# from D:\ProgramData\Anaconda3\lib\site-packages\pandas\_libs\tslib.cp36-win_amd64.pyd
# by generator 1.145
# no doc
...
import re as re # D:\ProgramData\Anaconda3\lib\re.py
import operator as operator # D:\ProgramData\Anaconda3\lib\operator.py
import collections as collections # D:\ProgramData\Anaconda3\lib\collections\__init__.py
import pytz as pytz # D:\ProgramData\Anaconda3\lib\site-packages\pytz\__init__.py
import time as time # <module 'time' (built-in)>
import locale as locale # D:\ProgramData\Anaconda3\lib\locale.py
import calendar as calendar # D:\ProgramData\Anaconda3\lib\calendar.py
...
def _get_docstring(*args, **kwargs): # real signature unknown
    pass
...
__test__ = {
    'Timedelta.isoformat (line 3023)': "\n        Format Timedelta as ISO 8601 Duration like\n        `P[n]Y[n]M[n]DT[n]H[n]M[n]S`, where the `[n]`s are replaced by the\n        values. See https://en.wikipedia.org/wiki/ISO_8601#Durations\n\n        .. versionadded:: 0.20.0\n\n        Returns\n        -------\n        formatted : str\n\n        Notes\n        -----\n        The longest component is days, whose value may be larger than\n        365.\n        Every component is always included, even if its value is 0.\n        Pandas uses nanosecond precision, so up to 9 decimal places may\n        be included in the seconds component.\n        Trailing 0's are removed from the seconds component after the decimal.\n        We do not 0 pad components, so it's `...T5H...`, not `...T05H...`\n\n        Examples\n        --------\n        >>> td = pd.Timedelta(days=6, minutes=50, seconds=3,\n        ...                   milliseconds=10, microseconds=10, nanoseconds=12)\n        >>> td.isoformat()\n        'P6DT0H50M3.010010012S'\n        >>> pd.Timedelta(hours=1, seconds=10).isoformat()\n        'P0DT0H0M10S'\n        >>> pd.Timedelta(hours=1, seconds=10).isoformat()\n        'P0DT0H0M10S'\n        >>> pd.Timedelta(days=500.5).isoformat()\n        'P500DT12H0MS'\n\n        See Also\n        --------\n        Timestamp.isoformat\n        ",
    '_get_rule_month (line 2179)': "\n    Return starting month of given freq, default is December.\n\n    Example\n    -------\n    >>> _get_rule_month('D')\n    'DEC'\n\n    >>> _get_rule_month('A-JAN')\n    'JAN'\n    ",
}
